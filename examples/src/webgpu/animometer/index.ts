...
const init = async (canvas: HTMLCanvasElement, gui: GUI) =>
{
    ...
    const renderObject: IGPURenderObject = {
        pipeline,
        vertices: {
            position: { data: vertexBuffer, format: "float32x4", offset: 0, vertexSize: 2 * vec4Size },
            color: { data: vertexBuffer, format: "float32x4", offset: vec4Size, vertexSize: 2 * vec4Size },
        },
        bindingResources: {},
