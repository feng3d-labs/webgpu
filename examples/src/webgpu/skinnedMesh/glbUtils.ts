...
import { getIGPUBuffer, gpuVertexFormatMap, IGPUBindingResources, IGPUBuffer, IGPUDrawIndexed, IGPUDrawVertex, IGPUFragmentState, IGPUPrimitiveState, IGPUVertexAttributes, IGPUVertexState } from "@feng3d/webgpu";
