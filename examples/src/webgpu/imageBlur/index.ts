...
import { IGPUBindingResources, IGPUBuffer, IGPUComputePassEncoder, IGPUComputePipeline, IGPURenderPassDescriptor, IGPURenderPassEncoder, IGPURenderPipeline, IGPUSampler, IGPUSubmit, IGPUTexture, WebGPU } from "webgpu-renderer";
...
const init = async (canvas: HTMLCanvasElement, gui: GUI) =>
{
    ...
    const gpuComputePassEncoder: IGPUComputePassEncoder = { computeObjects: [] };
