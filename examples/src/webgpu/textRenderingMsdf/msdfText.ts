...
import { IRenderPassObject, IRenderPipeline, ISampler, ITexture } from "@feng3d/render-api";
import { getIGPUBuffer, IGPUBindingResources, IGPURenderBundle } from "@feng3d/webgpu";
