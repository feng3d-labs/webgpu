import { BufferBinding, IUniformType, Sampler, TextureView } from "@feng3d/render-api";
...
export type IGPUBindingResource = Sampler | TextureView | IGPUExternalTexture | IUniformType;
