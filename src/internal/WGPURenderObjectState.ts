...
export class WGPURenderObjectState
{
    ...
    constructor(private passEncoder: GPURenderPassEncoder | GPURenderBundleEncoder)
    {
    }

    setViewport(x: number, y: number, width: number, height: number, minDepth: number, maxDepth: number)
    {
        if (this.passEncoder instanceof GPURenderBundleEncoder) return;
        ...
        this.passEncoder.setViewport(x, y, width, height, minDepth, maxDepth);
    ...
    setScissorRect(x: GPUIntegerCoordinate, y: GPUIntegerCoordinate, width: GPUIntegerCoordinate, height: GPUIntegerCoordinate)
    {
        ...
        this.passEncoder.setScissorRect(x, y, width, height);
    ...
    setBlendConstant(blendConstant: Color | undefined)
    {
        ...
        this.passEncoder.setBlendConstant(blendConstant);
    ...
    setStencilReference(stencilReference: number | undefined)
    {
        ...
        this.passEncoder.setStencilReference(stencilReference);
    ...
    setVertexBuffer(i: GPUIndex32, buffer: GPUBuffer | null | undefined, offset?: GPUSize64, size?: GPUSize64)
    {
        ...
        {
            this.passEncoder.setVertexBuffer(i, buffer, offset, size);
    ...
    setIndexBuffer(buffer: GPUBuffer | null | undefined, indexFormat: GPUIndexFormat, offset?: GPUSize64, size?: GPUSize64)
    {
        ...
        {
            this.passEncoder.setIndexBuffer(buffer, indexFormat, offset, size);
    ...
    {
        this.passEncoder.draw(vertexCount, instanceCount, firstVertex, firstInstance);
    ...
    beginOcclusionQuery(queryIndex: GPUSize32)
    {
        ...
        this.passEncoder.beginOcclusionQuery(queryIndex);
    ...
    endOcclusionQuery()
    {
        ...
        this.passEncoder.endOcclusionQuery();
