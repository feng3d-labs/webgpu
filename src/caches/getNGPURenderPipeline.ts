import { BlendState, DepthStencilState, FragmentState, IIndicesDataTypes, IWriteMask, Material, PrimitiveState, StencilFaceState, VertexAttributes, vertexFormatMap, VertexState, WGSLVertexType } from "@feng3d/render-api";
 ...
 */
export function getNGPURenderPipeline(renderPipeline: Material, renderPassFormat: IGPURenderPassFormat, primitive: PrimitiveState, vertices: VertexAttributes, indices: IIndicesDataTypes)
{
...
const renderPipelineMap = new ChainMap<
    [Material, string, PrimitiveState, VertexAttributes, GPUIndexFormat],
    {
        /**
         * GPU渲染管线描述。
         */
