import"../../../modulepreload-polyfill-3cfb730f.js";import{W as d,r as n}from"../../../Buffer-5212487c.js";const s=async i=>{const t=window.devicePixelRatio||1;i.width=i.clientWidth*t,i.height=i.clientHeight*t;const c=await new d().init(),o={pipeline:{vertex:{code:`
                @vertex
                fn main(
